  ...
  return (
    ...
    >
      <Text> 
        ...
        If the club you're a part of isn't currently on our <a href='https://hseclubs.com'>the club site</a> (please view on desktop as of now), and you can get your sponsor to put it there and ask for members of your club to join on the site, we will enter you in our giveaway. To enter, you must message our instagram <a target="_blank" href='https://instagram.com/hseapps'>@hseapps</a> with an email you sent to your sponsor and the name of your club. The winner will be announced November 6th, so act fast! 
      </Text>
    </Modal>
    </>
  );
